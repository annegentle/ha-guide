...
<xsl:template name="t:select-target-database">
...
<xsl:template name="t:select-olink-key">
  <xsl:param name="targetdoc.att" select="''"/>
  <xsl:param name="targetptr.att" select="''"/>
  <xsl:param name="olink.lang" select="''"/>
  ...
  <xsl:if test="$target.database/*">
    <xsl:variable name="olink.fallback.sequence">
      <xsl:call-template name="t:select-olink-lang-fallback">
...
<xsl:template name="t:select-olink-key-in-lang">
  <xsl:param name="targetdoc.att" select="''"/>
  <xsl:param name="targetptr.att" select="''"/>
  <xsl:param name="olink.lang" select="''"/>
  <xsl:param name="target.database"/>
...
<xsl:template name="t:select-target-lang">
  <xsl:param name="fallback.index" select="1"/>
  <xsl:param name="olink.fallback.sequence" select="''"/>
...
<xsl:template name="t:select-olink-lang-fallback">
  <xsl:param name="olink.lang" select="''"/>
...
<xsl:template name="t:make-olink-href">
...
<xsl:template name="t:olink-hottext">
  <xsl:param name="target.database"/>
  <xsl:param name="olink.lang" select="''"/>
  <xsl:param name="olink.key" select="''"/>
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <!-- old style olink -->
      <xsl:call-template name="t:olink-outline">
...
<xsl:template name="t:targetpath">
...
<xsl:template name="t:olink-page-citation">
  <xsl:param name="olink.key" select="''"/>
  ...
  <xsl:choose>
    <xsl:when test="$linkend != ''">
      <xsl:call-template name="t:xref-page-citation">
...
<xsl:template name="t:olink-document-citation">
  <xsl:param name="olink.key" select="''"/>
  <xsl:param name="olink.lang" select="'en'"/>
  <xsl:param name="target.database"/>
  <xsl:param name="xrefstyle" select="@xrefstyle"/>
...
<xsl:template name="t:xref-page-citation">
